...
final readonly class ApiKeysProvider implements ApiKeysProviderInterface, PrivateApiKeysProviderInterface
{
    /**
    ...
    public function getPrivateApiKey(ChannelInterface $channel, string $localeCode,): string
    {
        $channelsConfiguration = array_filter(
            $this->storesConfiguration,
            fn (array $storeConfiguration) => $storeConfiguration['channel_code'] === (string) $channel->getCode(),
